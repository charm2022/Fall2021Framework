...
public class WebCommands {
    ...
    public WebElement getElementWithScroll(By locator) {
        ...
        for (int i=1 ; i <= 20 ; i++) {
            try {
                element = (WebElement) UseDriver.getDriver().findElement(locator);
                break;
    ...
    public void selectFromDropdown(By locator, String dataToSelect) {
        ...
        Select dropdown = new Select((org.openqa.selenium.WebElement) dropdownElement);
    ...
    public void moveMouseToElement(By locator) {
        ...
        act.moveToElement((org.openqa.selenium.WebElement) element);
    }
